 ...
 * ```
 */
export declare function loadJsonModules(context: RequireContext): ModuleCollection;
/**
 ...
 * ```
 */
export declare function loadModulesWithTransform(context: RequireContext, transformName: (name: string) => string): ModuleCollection;
/**
 ...
 * ```
 */
export declare function getModuleNames(context: RequireContext): string[];
